import{s as c,h as b,t as p,j as x}from"./supabase.M5dTTGS6.js";document.addEventListener("DOMContentLoaded",async()=>{const o=document.getElementById("portfolio-table-body");if(!o)return;const l=async()=>{o.innerHTML=`
