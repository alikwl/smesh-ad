import{d as c,b,t as p,c as u}from"./supabase.DB6tOp5X.js";document.addEventListener("DOMContentLoaded",async()=>{const a=document.getElementById("blog-table-body");if(!a)return;const o=async()=>{a.innerHTML=`
